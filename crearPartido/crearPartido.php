...
<div class="d-flex justify-content-center">
    ...
    <div class="col-md-4">
        <div class="d-flex  mt-4 justify-content-center">
            <form action="crearPartido1.php" class="p-4" method="POST">
                <div class="mb-5">
                ...
                <div class="mb-3">
                    <label for="" class="form-label fw-semibold text-success-emphasis">Selecciona Jugador</label>
                    <select name="jugadorA" required>
                        <?php
                        mysqli_select_db($conexion, 'TenniStats');
                        $consulta =    "SELECT ficha_federativa, CONCAT(ficha_federativa, ' - ' ,apellidos, ', ' ,nombre) as datosJugador
                                        FROM jugadores
                                        ORDER BY apellidos 
                                        ";
                        ...
                        ?>
                            <option value="<?php echo $jugadores['ficha_federativa']; ?>"><?php echo $jugadores['datosJugador'] ?></option>
                        <?php
                        };
                        ?>
