    ...
    <table class="table table-hover text-center">
        ...
        <tbody>
            ...
            ?>
                ...
                ?></td>
                    <td class="text-center"><a href="borrarJugador1.php?id=<?php echo $registro['ficha_federativa'] ?>"><img src="../imagenesCRUD/borrar.png" alt="iconoModificar" height="30" width="30"></a></td>
                </tr>
            <?php
            };
            ?>
